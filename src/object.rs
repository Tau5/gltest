...
use crate::image::BindableTexture;
...
pub struct Object {
    ...
    scale: Vec3,
    vao: Box<dyn VAO>,
    diffuse_map: GLTexture,
    specular_map: Option<GLTexture>,
    emission_map: Option<GLTexture>,
    model: Mat4,
    normal: Mat3,
    has_collision: bool,
    aabb: AABB,
...
impl Object {
    pub fn new(translate: Vec3, rotation: Vec3, scale: Vec3, vao: Box<dyn VAO>, diffuse_map: GLTexture, specular_map: Option<GLTexture>, emission_map: Option<GLTexture>, has_collision: bool) -> Self {
        let mut out = Self {
            translate,
            rotation,
            scale,
    ...
    pub fn render(&self, shader: &ShaderProgram) {
        ...
        self.diffuse_map.bind(gl::TEXTURE0);
        ...
        if let Some(emission_map) = &self.emission_map {
